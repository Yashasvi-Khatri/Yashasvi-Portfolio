...
const ECOEDUCATOR_DATA = {
  ...
  solution: "Built a React + TypeScript + Vite + Firebase platform that transforms environmental education through interactive learning modules, gamification elements, and real-time progress tracking.",
  architecture: [
    { icon: Database, title: "Firebase", desc: "Real-time database for user progress, learning modules, and environmental data" },
    { icon: Server, title: "Vite", desc: "Fast build tool with hot module replacement and optimized development experience" },
    { icon: Globe, title: "React Frontend", desc: "Component-based architecture with TypeScript and responsive design" },
    { icon: Lock, title: "Firebase Auth", desc: "Authentication system with role-based access control" },
  ],
  challenges: [
  ...
  techStack: ["React", "TypeScript", "Vite", "Firebase", "shadcn/ui", "Tailwind CSS"],
